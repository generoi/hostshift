...
func diffPairs(t *testing.T) []Pair {
	...
	return []Pair{
		...
		{Name: "nat", Canonical: MustParse("https://www.acmecorpnat.fi"), Variant: MustParse("https://wt-a--nat.acmecorp.ddev.site")},
		{Name: "ddev", Canonical: MustParse("https://acmecorp.ddev.site"), Variant: MustParse("https://wt-a--acmecorp.ddev.site")},
		{Name: "port", Canonical: MustParse("https://www.acmecorp.fi:8443"), Variant: MustParse("http://v.ddev.site:8080")},
...
func TestScanMatchesAutomatonOnShapes(t *testing.T) {
	...
	for _, in := range []string{
		...
		"HTTPS://WWW.ACMECORP.FI/X",
		"http://www.acmecorp.fi",
		"//www.acmecorp.fi/",
		"//www.acmecorp.fi",
		"https:\\/\\/www.acmecorp.fi\\/x",
		"https%3A%2F%2Fwww.acmecorp.fi%2Fx",
		"https%3a%2f%2fwww.acmecorp.fi%2fx",
		"HTTPS%3A%2f%2Fwww.acmecorp.fi",
		"path//www.acmecorp.fi/x",
		"x//www.acmecorp.fi",
		"https://www.acmecorp.fi.",
		"https://www.acmecorp.fi./p",
		"see https://www.acmecorp.fi. Thanks",
		"https://www.acmecorp.fi:8443/x",
		"https://www.acmecorp.fi:9999/x",
		"https://www.acmecorp.fi%3A8443%2Fx",
		"https://ex.test/x",
		"https://ex.test.uk/x",
		...
		"https://www.acmecorp.fi.evil.example/x",
		"//www.acmecorp.fihttps://www.acmecorp.fi",
		"https://https://www.acmecorp.fi",
		"\\/\\/www.acmecorp.fi",
		"%2F%2Fwww.acmecorp.fi",
		"a//a.fi//a.fi//a.fi",
		"<a href=\"https://www.acmecorp.fi/a\">https://www.acmecorpnat.fi</a>",
		strings.Repeat("//www.acmecorp.fi/x ", 20),
	} {
		b := []byte(in)
...
func TestScanMatchesAutomatonFuzz(t *testing.T) {
	...
	hosts := []string{
		"www.acmecorp.fi", "WWW.ACMECORP.FI", "Www.Acmecorp.Fi",
		"www.acmecorpnat.fi", "acmecorp.ddev.site", "ex.test", "ex.test.uk",
		"a.fi", "hämeen.fi", "HÄMEEN.FI", "xn--hmeen-loa.fi",
		"www.acmecorp.f", "www.acmecorp.fix", "ex.tes", "a.f",
	}
	tails := []string{
