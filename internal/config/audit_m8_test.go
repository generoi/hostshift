...
func TestFromWithSlugDerivesVariants(t *testing.T) {
	res, err := Load(t.TempDir(), Flags{
		From: []string{"https://herrfors.ddev.site", "https://nat.herrfors.ddev.site"},
		Slug: "wt-a",
	})
	if err != nil {
		t.Fatal(err)
	...
	for _, want := range []string{
		...
		"https://wt-a--herrfors.ddev.site",
		"https://nat.herrfors.ddev.site",
		"https://wt-a--nat.herrfors.ddev.site",
	} {
