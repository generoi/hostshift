...
func cmdInit(args []string) (int, error) {
	...
	// additional_hostnames come with it: acmecorp-wt-a registers
	// nat.acmecorp.ddev.site as well as its own name. Handing that to web makes
	...
	cfg := "# generated by hostshift init — delete it to undo, rerun to update.\n" +
		"#\n" +
...
func writeMapFromParent(dir, slug string) (string, error) {
	...
	body := "# generated by hostshift init — delete it to undo, rerun to update.\n" +
		"#\n" +
